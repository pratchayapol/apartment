...
$sql_6_months = "
    ...
    FROM rental
    WHERE rental_timestam BETWEEN NOW() - INTERVAL 5 MONTH AND NOW()
    GROUP BY DATE_FORMAT(rental_timestam, '%Y-%m')
    ORDER BY month
";

$result_6_months = $conn->query($sql_6_months);

$data = [];
if ($result_6_months) {
    while ($row = $result_6_months->fetch_assoc()) {
        $data[] = $row;
    }
}
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                <div class="card text-back">
                    <div class="card-header">6-Month Report</div>
                    <div class="card-body">
